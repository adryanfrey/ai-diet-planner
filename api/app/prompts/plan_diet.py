...
INPUT_GUARDRAIL_AGENT_INSTRUCTIONS = (
    ...
    "- reasoning: string - a friendly explanation written in plain language for the end user. "
    "NEVER use technical jargon (e.g., 'injection', 'malformed', 'payload', 'schema'). "
    "Write as if explaining to a friend - be warm and helpful. If unsafe, explain what's wrong and how to fix it "
    "(e.g., 'Please make sure your medical conditions field only contains health information').\n\n"
...
MEAL_PLANNER_AGENT_INSTRUCTIONS = (
    ...
    "Each daily plan must include a short and concise description that explains:\n"
    ...
    "Keep the description brief and concise- aim for 4-5 sentences maximum.\n\n"
